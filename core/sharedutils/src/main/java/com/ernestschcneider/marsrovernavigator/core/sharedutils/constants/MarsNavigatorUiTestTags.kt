package com.ernestschcneider.marsrovernavigator.core.sharedutils.constants

object MarsNavigatorUiTestTags {
    ...
    const val MOVE_BUTTON_TEST_TAG = "sendMoveButtonTestTag"
